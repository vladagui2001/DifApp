...
<form class="form-group" method="POST" action="{{action('DifUserController@update', $User->id)}}" enctype="multipart/form-data"> 
    ...
    @csrf
            ...
            <input type='text'name="Nombre" class='form-control' value="{{$User->Nombre}}"> <br>

            <label for=''>CURP:</label>
            <input type='text'name="Curp" class='form-control' value="{{$User->Curp}}"> <br>
            ...
            <input type='text'name="NoDeHijos" class='form-control' value="{{$User->NoDeHijos}}"> <br>
            ...
            <input type='text'name="Nomdiscap" class='form-control' value="{{$User->Nomdiscap}}"> <br>

            <label for=''>¿Cuál es su ingreso mensual?:</label>
            <input type='text'name="Ing_Men" class='form-control' value="{{$User->Ing_Men}}"> <br>
